...
class Mul(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, Tensor]:
        ...
        return b.f.mul_zip(grad_output, b), a.f.mul_zip(grad_output, a)
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        ...
        return grad_output.f.mul_zip(
            ...
            grad_output.f.mul_zip(
                a, grad_output.f.add_zip(tensor([1.0]), grad_output.f.neg_map(a))
            ),
        )
...
class Permute(Function):
    ...
    def forward(ctx: Context, a: Tensor, order: Tensor) -> Tensor:
        ...
        return a._new(a._tensor.permute(*[int(order[x]) for x in range(order.size)]))
