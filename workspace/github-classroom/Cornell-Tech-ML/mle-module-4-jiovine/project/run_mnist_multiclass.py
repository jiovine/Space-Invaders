...
class Network(minitorch.Module):
    ...
    def __init__(self):
        ...
        # TODO: Implement for Task 4.5.
        self.conv_4 = Conv2d(1, 4, 3, 3)
        self.conv_8 = Conv2d(4, 8, 3, 3)
        self.layer1 = Linear(392, 64)
        self.layer2 = Linear(64, 10)

    def forward(self, x):
        # TODO: Implement for Task 4.5.
        self.mid = self.conv_4.forward(x).relu()
        self.out = self.conv_8.forward(self.mid).relu()
        l = minitorch.avgpool2d(self.out, (4, 4))
        l = l.view(BATCH, 392)
        l = self.layer1.forward(l).relu()
